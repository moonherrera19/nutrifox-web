...
export default function MostrarConvocatorias() {
  ...
  return convocatorias.length === 0 ? (
    <h2 className="font-bold text-3xl">No hay convocatorias disponibles</h2>
  ) : (
          ...
          <CardFooter>
            <div className="grid grid-cols-2 gap-2 w-full">
              {convocatoria.estatus ? (
                ...
                >
                  <Link
                    href={`/aplicacion/estudiantes/solicitudes/aplicar/${convocatoria.idConvocatoria}`}
                  >
                    Aplicar
                  </Link>
                </Button>
